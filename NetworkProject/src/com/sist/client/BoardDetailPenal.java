...
public class BoardDetailPenal extends JPanel implements ActionListener{
	...
	public BoardDetailPenal(ControlPanel cp) {
		this.cp=cp;
...
//		p.add(b2);
//		p.add(b3);
//		p.setBounds(10, 345, 675, 35);
		b3.setBounds(300, 360, 60, 20);
		add(b3);
